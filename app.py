...
# 1. 🖼️ সাবজেক্টের সীমানা অনুযায়ী ক্রপ করা
...
def remove_background_optimized(image: PILImage.Image) -> PILImage.Image:
    ...
    try:
        ...
        # 🎯 পোস্ট-প্রসেসিং পাইপলাইন (Refine Edge Effect)
...
async def root():
    return {
        ...
        "bg_removal_quality": "Optimized High Quality (Advanced Refine Edge)",
...
async def remove_bg(
    ...
    """
    Remove background with improved quality
    """
    try:
        ...
        processed_img = remove_background_optimized(img)
        ...
        return {
            ...
            "message": "Background removed with optimized quality and Refine Edge feature.",
...
def cleanup_files():
    while True:
        try:
            ...
            for folder in [UPLOAD_FOLDER, REMOVEBG_FOLDER, VECTOR_FOLDER]: # Added VECTOR_FOLDER
...
if __name__ == "__main__":
    ...
    print("  1. Background Removal (API: /remove-bg)")
    print("  2. SVG Vectorization (API: /vectorize)")
    print("=" * 60)
